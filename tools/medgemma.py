...
def medgemma_tool(image_path: str) -> str:
    ...
    # Dummy logic: In reality, you'd run inference here
    dummy_response = """The chest X-ray shows a posteroanterior (PA) view of the thorax with proper inspiration and no significant rotation. The trachea appears central, and the cardiac silhouette is within normal   limits. The bony structures, including ribs, clavicles, and shoulders, appear intact.
